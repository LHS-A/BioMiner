...
from biominer.data import FusionDataset
from biominer.fusion import BioMinerFusion
from biominer.text import TaskAdaptedTextEncoder
from biominer.vision import DualTaskVisionClassifier, load_checkpoint
...
def main() -> None:
    ...
    load_checkpoint(vision_model, args.vision_checkpoint)
